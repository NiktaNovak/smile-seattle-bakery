...
export const sendOrderConfirmation = async (order) => {
    ...
    try {
        ...
        console.log(
            `Confirmation email sent for Order #${order.order_id}`
        );
...
// NANA / BAKERY OWNER NOTIFICATION
export const sendNewOrderNotification = async (order) => {
    ...
    try {
        ...
        console.log(
            `New order notification sent for Order #${order.order_id}`
        );
...
export const sendOrderReadyNotification = async (order) => {
    ...
    try {
        ...
        console.log(
            `Ready-for-pickup email sent for Order #${order.order_id}`
        );
...
export const sendContactOwnerNotification = async (inquiry) => {
    ...
    try {
        ...
        console.log(
            `Contact request email sent to owner from ${inquiry.email}`
        );
...
export const sendContactConfirmation = async (inquiry) => {
    ...
    try {
        ...
        console.log(
            `Contact confirmation email sent to ${inquiry.email}`
        );
